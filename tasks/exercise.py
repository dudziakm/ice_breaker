...
def implement_compare_models(prompt):
    ...
    """
    response4 = implement_query_model(implement_llama_4_model(), prompt)
    response33 = implement_query_model(implement_llama_3_3_model(), prompt)

    resp_dist = {"llama_4": response4, "llama_3_3": response33}
